...
function CheckOutPage() {
  ...
  return (
    <div>
      <div className="checkout-head bg-white gap-5 h-12 w-full flex flex-row overflow-x-hidden">
      <Link href="/">
            <h1 className="pt-3 pl-10 text-primary text-lg font-bold">BWE</h1>
          </Link>
        <div className="">
         
          <div className="checkout-text flex">
            <h1 className=" md:text-center md:ml-[30rem] pt-3 uppercase font-bold text-2xl">
              Fill in details
            </h1>

            <Link href="/cart">
              <div className=" relative pt-5 md:ml-[8rem]">
                <div>
                  <svg
