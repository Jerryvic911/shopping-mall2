...
function InputDetails() {
	...
	return (
		<div className="ml-20 mt-7">
            ...
            <input type="text" onChange={handleChange} name="" className="grow" placeholder="Home ADDRESS" />
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              ...
              />
					...
					<label className="input input-bordered bg-white flex items-center w-[40rem] mt-5 gap-2">
						<input
							...
							defaultValue={checkutDetails.deliveryAddress}
							type="text"
							className="grow"
					...
					<div className="flex gap-6">
						<label className="input mt-5 input-bordered flex  bg-white items-center w-[20rem] gap-2">
							<input
								defaultValue={checkutDetails.region}
								onChange={handleChange}
								name="region"
								type="text"
								className="grow"
						...
						<label className="input mt-5 input-bordered flex  bg-white items-center w-[18.4rem] gap-2">
							<input
								defaultValue={checkutDetails.city}
								onChange={handleChange}
								name="city"
								type="text"
								className="grow"
